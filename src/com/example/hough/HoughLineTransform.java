 ...
 * </p> 
 * 
 * @authors Olly Oechsle, University of Essex, Jakub Medvecký-Heretik
 */ 
public class HoughLineTransform { 
    ...
    /** 
     * Adds points from an image (in OpenCV's org.opencv.core.Mat format). The image is assumed to be greyscale black and white, so all pixels that are 
     * not black are counted as edges. The image should have the same dimensions as the one passed to the constructor.
     * 
